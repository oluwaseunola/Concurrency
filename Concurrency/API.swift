  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CourseCollection: GraphQLSelectionSet {
      ...
      public struct Course: GraphQLSelectionSet {
        ...
        public init(sys: Sy, title: String? = nil, subtitle: String? = nil, numberOfSections: Int? = nil, numberOfHours: Int? = nil, subject: String? = nil, colors: [String?]? = nil, image: Image? = nil, sectionCollection: SectionCollection? = nil) {
          self.init(unsafeResultMap: ["__typename": "Course", "sys": sys.resultMap, "title": title, "subtitle": subtitle, "numberOfSections": numberOfSections, "numberOfHours": numberOfHours, "subject": subject, "colors": colors, "image": image.flatMap { (value: Image) -> ResultMap in value.resultMap }, "sectionCollection": sectionCollection.flatMap { (value: SectionCollection) -> ResultMap in value.resultMap }])
        }
...
public final class SectionsQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    query Sections {
  ...
  public let operationName: String = "Sections"
