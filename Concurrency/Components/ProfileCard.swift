...
struct ProfileCard_Previews: PreviewProvider {
    static var previews: some View {
        ProfileCard(user: User(id: 1, name: "Bob", username: "Milk", email: "", address: Address(street: "", suite: "", city: "", zipcode: "", geo: Geo(lat: "", lng: "")), phone: "", website: "", company: Company(name: "Apple", catchPhrase: "Big Baby", bs: "")))
    }
}
